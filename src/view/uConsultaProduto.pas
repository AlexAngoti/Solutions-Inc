...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, uConsultaPadrao, cxGraphics, cxControls,
...
type
  TfrmConsultaProduto = class(TfrmConsultaPadrao)
    ...
    procedure dbGrdPesquisaDBTableView1CellDblClick(
...
procedure TfrmConsultaProduto.dbGrdPesquisaDBTableView1CellDblClick(
