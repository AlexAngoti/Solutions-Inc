object frmParcelas: TfrmParcelas
  ...
  object qryFormaPgto: TFDQuery
    ...
    object qryFormaPgtoatualizapagar: TIntegerField
      FieldName = 'atualizapagar'
      Origin = 'atualizapagar'
    end
    object qryFormaPgtoatualizareceber: TIntegerField
  ...
  object cdsParcelas: TClientDataSet
    ...
    object cdsParcelasdatavenc: TDateField
      FieldName = 'datavenc'
    end
  end
  ...
  object qryAtuReceber: TFDQuery
    ...
    object qryAtuReceberdataemissao: TDateField
      FieldName = 'dataemissao'
      Origin = 'dataemissao'
    end
    object qryAtuReceberdatavencimento: TDateField
      FieldName = 'datavencimento'
      Origin = 'datavencimento'
    end
    object qryAtuRecebervalor: TBCDField
      FieldName = 'valor'
      Origin = 'valor'
      Precision = 15
      Size = 2
    end
    object qryAtuReceberformapgto: TIntegerField
      FieldName = 'formapgto'
      Origin = 'formapgto'
    end
    object qryAtuReceberidcliente: TIntegerField
      FieldName = 'idcliente'
      Origin = 'idcliente'
    end
    object qryAtuReceberdatabaixa: TDateField
      FieldName = 'databaixa'
      Origin = 'databaixa'
    end
    object qryAtuReceberdescricao: TWideStringField
      FieldName = 'descricao'
      Origin = 'descricao'
      Size = 255
    end
    object qryAtuRecebernumerodoc: TWideStringField
      FieldName = 'numerodoc'
      Origin = 'numerodoc'
      Size = 60
    end
    object qryAtuReceberobservaobaixa: TWideStringField
      FieldName = 'observaobaixa'
      Origin = 'observaobaixa'
      Size = 255
    end
    object qryAtuRecebernumeroorigem: TIntegerField
