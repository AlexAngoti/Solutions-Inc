...
type
  TfrmPesquisaPadraoForn = class(TForm)
    pnlPrincipal: TPanel;
    pnlPesquisa: TPanel;
    lblPesquisar: TLabel;
...
var
  frmPesquisaPadraoForn: TfrmPesquisaPadraoForn;
...
procedure TfrmPesquisaPadraoForn.btnFecharClick(Sender: TObject);
begin
  Self.Close;
end;

procedure TfrmPesquisaPadraoForn.btnPesquisaClick(Sender: TObject);
begin
...
procedure TfrmPesquisaPadraoForn.cxGrid1DBTableView1DblClick(Sender: TObject);
begin
  frmPesquisaPadraoForn.ModalResult := mrOk;
end;

procedure TfrmPesquisaPadraoForn.dbgdConsultaDblClick(Sender: TObject);
begin
  frmPesquisaPadraoForn.ModalResult := mrOk;
end;

procedure TfrmPesquisaPadraoForn.FormShow(Sender: TObject);
begin
  qryPadrao.Close;
  qryPadrao.Open;
end;
