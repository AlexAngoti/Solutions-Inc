inherited frmRelatorioContasReceber: TfrmRelatorioContasReceber
  Caption = 'frmRelatorioContasReceber'
  OnShow = FormShow
  PixelsPerInch = 96
  TextHeight = 13
  inherited pnlTop: TPanel
    inherited lblNomeLogoTop: TLabel
      Width = 261
      Caption = 'SOLUTIONS INC / Relat'#243'rio Contas Receber'
      ExplicitWidth = 261
    end
  end
  ...
  inherited qryRelPadrao: TFDQuery
    ...
    SQL.Strings = (
      ...
      ' inner join pessoa p on c.idcliente  = p.id '
      '   and p.tipopessoa = 0'
      ' where c.dataemissao between :dataini and :datafin'
      '   and (c.idcliente = :idcliente) or (:idcliente = 0)'
  ...
  inherited cdsRelPadrao: TClientDataSet
    ...
    object cdsRelPadraoidcliente: TIntegerField
      FieldName = 'idcliente'
    end
